...
{
    return ImGui::PlotLines(label,values_getter)(data,idx)data,values_count,values_offset,overlay_text,scale_min,scale_max,graph_size);
}
...
{
    return ImGui::PlotHistogram(label,values_getter)(data,idx)data,values_count,values_offset,overlay_text,scale_min,scale_max,graph_size);
}
...
{
    return ImGui::Combo(label,current_item,items_count,popup_max_height_in_items);
}
...
{
    return ImGui::Combo(label,current_item,items_getter)(data,idx,out_text)data,items_count,popup_max_height_in_items);
}
...
{
    return ImGui::DragFloat2(label,v_speed,v_min,v_max,display_format,power);
}
...
{
    return ImGui::DragFloat3(label,v_speed,v_min,v_max,display_format,power);
}
...
{
    return ImGui::DragFloat4(label,v_speed,v_min,v_max,display_format,power);
}
...
{
    return ImGui::ListBox(label,current_item,items_count,height_in_items);
}
...
{
    return ImGui::ListBox(label,current_item,items_getter)(data,idx,out_text)data,items_count,height_in_items);
}
...
{
    return ImGui::SetAllocatorFunctions(alloc_func)(sz,user_data)free_func)(ptr,user_data)user_data);
}
...
{
    return self->GetMouseCursorTexData(cursor,out_offset,out_size,ImVec2 out_uv_border[2],ImVec2 out_uv_fill[2]);
}
