...
CIMGUI_API ImVec2 igImLerpVec2Float(const ImVec2 a,const ImVec2 b,float t)
{
    return ImLerp(a,b,t);
}
CIMGUI_API ImVec2 igImLerpVec2Vec2(const ImVec2 a,const ImVec2 b,const ImVec2 t)
{
    return ImLerp(a,b,t);
}
CIMGUI_API ImVec4 igImLerpVec4(const ImVec4 a,const ImVec4 b,float t)
{
    return ImLerp(a,b,t);
}
...
CIMGUI_API ImVec2 igImFloorVec2(const ImVec2 v)
{
    return ImFloor(v);
}
...
CIMGUI_API ImVec2 igImBezierCalc(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,float t)
{
    return ImBezierCalc(p1,p2,p3,p4,t);
}
CIMGUI_API ImVec2 igImBezierClosestPoint(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 p,int num_segments)
{
    return ImBezierClosestPoint(p1,p2,p3,p4,p,num_segments);
}
CIMGUI_API ImVec2 igImBezierClosestPointCasteljau(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 p,float tess_tol)
{
    return ImBezierClosestPointCasteljau(p1,p2,p3,p4,p,tess_tol);
}
...
CIMGUI_API ImVec2 igCalcWindowExpectedSize(ImGuiWindow* window)
{
    return ImGui::CalcWindowExpectedSize(window);
}
...
CIMGUI_API ImRect igGetWindowAllowedExtentRect(ImGuiWindow* window)
{
    return ImGui::GetWindowAllowedExtentRect(window);
}
...
CIMGUI_API ImVec2 igScrollToBringRectIntoView(ImGuiWindow* window,const ImRect item_rect)
{
    return ImGui::ScrollToBringRectIntoView(window,item_rect);
}
...
CIMGUI_API ImVec2 igGetNavInputAmount2d(ImGuiNavDirSourceFlags dir_sources,ImGuiInputReadMode mode,float slow_factor,float fast_factor)
{
    return ImGui::GetNavInputAmount2d(dir_sources,mode,slow_factor,fast_factor);
}
...
CIMGUI_API ImVec2 igTabItemCalcSize(const char* label,bool has_close_button)
{
    return ImGui::TabItemCalcSize(label,has_close_button);
}
...
CIMGUI_API void igImMin_nonUDT(ImVec2 *pOut,const ImVec2 lhs,const ImVec2 rhs)
{
    *pOut = ImMin(lhs,rhs);
}
CIMGUI_API ImVec2_Simple igImMin_nonUDT2(const ImVec2 lhs,const ImVec2 rhs)
{
    ImVec2 ret = ImMin(lhs,rhs);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImMax_nonUDT(ImVec2 *pOut,const ImVec2 lhs,const ImVec2 rhs)
{
    *pOut = ImMax(lhs,rhs);
}
CIMGUI_API ImVec2_Simple igImMax_nonUDT2(const ImVec2 lhs,const ImVec2 rhs)
{
    ImVec2 ret = ImMax(lhs,rhs);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImClamp_nonUDT(ImVec2 *pOut,const ImVec2 v,const ImVec2 mn,ImVec2 mx)
{
    *pOut = ImClamp(v,mn,mx);
}
CIMGUI_API ImVec2_Simple igImClamp_nonUDT2(const ImVec2 v,const ImVec2 mn,ImVec2 mx)
{
    ImVec2 ret = ImClamp(v,mn,mx);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImLerpVec2Float_nonUDT(ImVec2 *pOut,const ImVec2 a,const ImVec2 b,float t)
{
    *pOut = ImLerp(a,b,t);
}
CIMGUI_API ImVec2_Simple igImLerpVec2Float_nonUDT2(const ImVec2 a,const ImVec2 b,float t)
{
    ImVec2 ret = ImLerp(a,b,t);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImLerpVec2Vec2_nonUDT(ImVec2 *pOut,const ImVec2 a,const ImVec2 b,const ImVec2 t)
{
    *pOut = ImLerp(a,b,t);
}
CIMGUI_API ImVec2_Simple igImLerpVec2Vec2_nonUDT2(const ImVec2 a,const ImVec2 b,const ImVec2 t)
{
    ImVec2 ret = ImLerp(a,b,t);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImLerpVec4_nonUDT(ImVec4 *pOut,const ImVec4 a,const ImVec4 b,float t)
{
    *pOut = ImLerp(a,b,t);
}
CIMGUI_API ImVec4_Simple igImLerpVec4_nonUDT2(const ImVec4 a,const ImVec4 b,float t)
{
    ImVec4 ret = ImLerp(a,b,t);
    ImVec4_Simple ret2 = ImVec4ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImFloorVec2_nonUDT(ImVec2 *pOut,const ImVec2 v)
{
    *pOut = ImFloor(v);
}
CIMGUI_API ImVec2_Simple igImFloorVec2_nonUDT2(const ImVec2 v)
{
    ImVec2 ret = ImFloor(v);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImRotate_nonUDT(ImVec2 *pOut,const ImVec2 v,float cos_a,float sin_a)
{
    *pOut = ImRotate(v,cos_a,sin_a);
}
CIMGUI_API ImVec2_Simple igImRotate_nonUDT2(const ImVec2 v,float cos_a,float sin_a)
{
    ImVec2 ret = ImRotate(v,cos_a,sin_a);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImMul_nonUDT(ImVec2 *pOut,const ImVec2 lhs,const ImVec2 rhs)
{
    *pOut = ImMul(lhs,rhs);
}
CIMGUI_API ImVec2_Simple igImMul_nonUDT2(const ImVec2 lhs,const ImVec2 rhs)
{
    ImVec2 ret = ImMul(lhs,rhs);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImBezierCalc_nonUDT(ImVec2 *pOut,const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,float t)
{
    *pOut = ImBezierCalc(p1,p2,p3,p4,t);
}
CIMGUI_API ImVec2_Simple igImBezierCalc_nonUDT2(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,float t)
{
    ImVec2 ret = ImBezierCalc(p1,p2,p3,p4,t);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImBezierClosestPoint_nonUDT(ImVec2 *pOut,const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 p,int num_segments)
{
    *pOut = ImBezierClosestPoint(p1,p2,p3,p4,p,num_segments);
}
CIMGUI_API ImVec2_Simple igImBezierClosestPoint_nonUDT2(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 p,int num_segments)
{
    ImVec2 ret = ImBezierClosestPoint(p1,p2,p3,p4,p,num_segments);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImBezierClosestPointCasteljau_nonUDT(ImVec2 *pOut,const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 p,float tess_tol)
{
    *pOut = ImBezierClosestPointCasteljau(p1,p2,p3,p4,p,tess_tol);
}
CIMGUI_API ImVec2_Simple igImBezierClosestPointCasteljau_nonUDT2(const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4,const ImVec2 p,float tess_tol)
{
    ImVec2 ret = ImBezierClosestPointCasteljau(p1,p2,p3,p4,p,tess_tol);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImLineClosestPoint_nonUDT(ImVec2 *pOut,const ImVec2 a,const ImVec2 b,const ImVec2 p)
{
    *pOut = ImLineClosestPoint(a,b,p);
}
CIMGUI_API ImVec2_Simple igImLineClosestPoint_nonUDT2(const ImVec2 a,const ImVec2 b,const ImVec2 p)
{
    ImVec2 ret = ImLineClosestPoint(a,b,p);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igImTriangleClosestPoint_nonUDT(ImVec2 *pOut,const ImVec2 a,const ImVec2 b,const ImVec2 c,const ImVec2 p)
{
    *pOut = ImTriangleClosestPoint(a,b,c,p);
}
CIMGUI_API ImVec2_Simple igImTriangleClosestPoint_nonUDT2(const ImVec2 a,const ImVec2 b,const ImVec2 c,const ImVec2 p)
{
    ImVec2 ret = ImTriangleClosestPoint(a,b,c,p);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void ImRect_GetCenter_nonUDT(ImVec2 *pOut,ImRect* self)
{
    *pOut = self->GetCenter();
}
CIMGUI_API ImVec2_Simple ImRect_GetCenter_nonUDT2(ImRect* self)
{
    ImVec2 ret = self->GetCenter();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void ImRect_GetSize_nonUDT(ImVec2 *pOut,ImRect* self)
{
    *pOut = self->GetSize();
}
CIMGUI_API ImVec2_Simple ImRect_GetSize_nonUDT2(ImRect* self)
{
    ImVec2 ret = self->GetSize();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void ImRect_GetTL_nonUDT(ImVec2 *pOut,ImRect* self)
{
    *pOut = self->GetTL();
}
CIMGUI_API ImVec2_Simple ImRect_GetTL_nonUDT2(ImRect* self)
{
    ImVec2 ret = self->GetTL();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void ImRect_GetTR_nonUDT(ImVec2 *pOut,ImRect* self)
{
    *pOut = self->GetTR();
}
CIMGUI_API ImVec2_Simple ImRect_GetTR_nonUDT2(ImRect* self)
{
    ImVec2 ret = self->GetTR();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void ImRect_GetBL_nonUDT(ImVec2 *pOut,ImRect* self)
{
    *pOut = self->GetBL();
}
CIMGUI_API ImVec2_Simple ImRect_GetBL_nonUDT2(ImRect* self)
{
    ImVec2 ret = self->GetBL();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void ImRect_GetBR_nonUDT(ImVec2 *pOut,ImRect* self)
{
    *pOut = self->GetBR();
}
CIMGUI_API ImVec2_Simple ImRect_GetBR_nonUDT2(ImRect* self)
{
    ImVec2 ret = self->GetBR();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igCalcWindowExpectedSize_nonUDT(ImVec2 *pOut,ImGuiWindow* window)
{
    *pOut = ImGui::CalcWindowExpectedSize(window);
}
CIMGUI_API ImVec2_Simple igCalcWindowExpectedSize_nonUDT2(ImGuiWindow* window)
{
    ImVec2 ret = ImGui::CalcWindowExpectedSize(window);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igScrollToBringRectIntoView_nonUDT(ImVec2 *pOut,ImGuiWindow* window,const ImRect item_rect)
{
    *pOut = ImGui::ScrollToBringRectIntoView(window,item_rect);
}
CIMGUI_API ImVec2_Simple igScrollToBringRectIntoView_nonUDT2(ImGuiWindow* window,const ImRect item_rect)
{
    ImVec2 ret = ImGui::ScrollToBringRectIntoView(window,item_rect);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igCalcItemSize_nonUDT(ImVec2 *pOut,ImVec2 size,float default_w,float default_h)
{
    *pOut = ImGui::CalcItemSize(size,default_w,default_h);
}
CIMGUI_API ImVec2_Simple igCalcItemSize_nonUDT2(ImVec2 size,float default_w,float default_h)
{
    ImVec2 ret = ImGui::CalcItemSize(size,default_w,default_h);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igGetContentRegionMaxAbs_nonUDT(ImVec2 *pOut)
{
    *pOut = ImGui::GetContentRegionMaxAbs();
}
CIMGUI_API ImVec2_Simple igGetContentRegionMaxAbs_nonUDT2()
{
    ImVec2 ret = ImGui::GetContentRegionMaxAbs();
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igFindBestWindowPosForPopup_nonUDT(ImVec2 *pOut,ImGuiWindow* window)
{
    *pOut = ImGui::FindBestWindowPosForPopup(window);
}
CIMGUI_API ImVec2_Simple igFindBestWindowPosForPopup_nonUDT2(ImGuiWindow* window)
{
    ImVec2 ret = ImGui::FindBestWindowPosForPopup(window);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igFindBestWindowPosForPopupEx_nonUDT(ImVec2 *pOut,const ImVec2 ref_pos,const ImVec2 size,ImGuiDir* last_dir,const ImRect r_outer,const ImRect r_avoid,ImGuiPopupPositionPolicy policy)
{
    *pOut = ImGui::FindBestWindowPosForPopupEx(ref_pos,size,last_dir,r_outer,r_avoid,policy);
}
CIMGUI_API ImVec2_Simple igFindBestWindowPosForPopupEx_nonUDT2(const ImVec2 ref_pos,const ImVec2 size,ImGuiDir* last_dir,const ImRect r_outer,const ImRect r_avoid,ImGuiPopupPositionPolicy policy)
{
    ImVec2 ret = ImGui::FindBestWindowPosForPopupEx(ref_pos,size,last_dir,r_outer,r_avoid,policy);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igGetNavInputAmount2d_nonUDT(ImVec2 *pOut,ImGuiNavDirSourceFlags dir_sources,ImGuiInputReadMode mode,float slow_factor,float fast_factor)
{
    *pOut = ImGui::GetNavInputAmount2d(dir_sources,mode,slow_factor,fast_factor);
}
CIMGUI_API ImVec2_Simple igGetNavInputAmount2d_nonUDT2(ImGuiNavDirSourceFlags dir_sources,ImGuiInputReadMode mode,float slow_factor,float fast_factor)
{
    ImVec2 ret = ImGui::GetNavInputAmount2d(dir_sources,mode,slow_factor,fast_factor);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
CIMGUI_API void igTabItemCalcSize_nonUDT(ImVec2 *pOut,const char* label,bool has_close_button)
{
    *pOut = ImGui::TabItemCalcSize(label,has_close_button);
}
CIMGUI_API ImVec2_Simple igTabItemCalcSize_nonUDT2(const char* label,bool has_close_button)
{
    ImVec2 ret = ImGui::TabItemCalcSize(label,has_close_button);
    ImVec2_Simple ret2 = ImVec2ToSimple(ret);
    return ret2;
}
