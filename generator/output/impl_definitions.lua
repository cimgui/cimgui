local t={
  ...
  ImGui_ImplSDLGPU3_Init={
    [1]={
      ...
      stname=""},
    ["(ImGui_ImplSDLGPU3_InitInfo*)"]=nil},
  ...
  ImGui_ImplSDLGPU3_RenderDrawData={
    [1]={
      ...
      stname=""},
    ["(ImDrawData*,SDL_GPUCommandBuffer*,SDL_GPURenderPass*,SDL_GPUGraphicsPipeline*)"]=nil},
  ...
  Imgui_ImplSDLGPU3_PrepareDrawData={
    [1]={
      ...
      stname=""},
    ["(ImDrawData*,SDL_GPUCommandBuffer*)"]=nil}}
...
t.ImGui_ImplSDLGPU3_CreateDeviceObjects["()"]=t.ImGui_ImplSDLGPU3_CreateDeviceObjects[1]
t.ImGui_ImplSDLGPU3_CreateFontsTexture["()"]=t.ImGui_ImplSDLGPU3_CreateFontsTexture[1]
t.ImGui_ImplSDLGPU3_DestroyDeviceObjects["()"]=t.ImGui_ImplSDLGPU3_DestroyDeviceObjects[1]
t.ImGui_ImplSDLGPU3_DestroyFontsTexture["()"]=t.ImGui_ImplSDLGPU3_DestroyFontsTexture[1]
t.ImGui_ImplSDLGPU3_Init["(ImGui_ImplSDLGPU3_InitInfo*)"]=t.ImGui_ImplSDLGPU3_Init[1]
t.ImGui_ImplSDLGPU3_NewFrame["()"]=t.ImGui_ImplSDLGPU3_NewFrame[1]
t.ImGui_ImplSDLGPU3_RenderDrawData["(ImDrawData*,SDL_GPUCommandBuffer*,SDL_GPURenderPass*,SDL_GPUGraphicsPipeline*)"]=t.ImGui_ImplSDLGPU3_RenderDrawData[1]
t.ImGui_ImplSDLGPU3_Shutdown["()"]=t.ImGui_ImplSDLGPU3_Shutdown[1]
t.Imgui_ImplSDLGPU3_PrepareDrawData["(ImDrawData*,SDL_GPUCommandBuffer*)"]=t.Imgui_ImplSDLGPU3_PrepareDrawData[1]
 return t
